...
public class OurProductsMethodForRandomlySelectedCategAndViewAll {
	...
	public OurProductsMethodForRandomlySelectedCategAndViewAll(WebDriver driver) {

		this.driver = driver;
	}

	public void verifyForRandomCategAndViewAll(String fName, String midName, String lName, String mobNum, String pan) {
		...
		try {
			...
			/* Clicking on View All Cursor Button */

			action.click(op.getViewAllCursorButton()).build().perform();
			...
			js.executeScript("arguments[0].scrollIntoView();",
					list2.get(randCards.nextInt(totalCardsForParticularSelectedCategory)));
