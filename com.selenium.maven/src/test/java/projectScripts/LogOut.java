...
public WebDriver driver;
	...
	
	{
		...
		
		{
			...
			w=driver.findElement(By.cssSelector(".menusubnav >li:nth-child(15) >a"));
			...
			if(a.getText().contains("You"))
				
			{
				
				Assert.assertTrue(a.getText().contains("You"));
			...
			ScreenshortUtility.takeScreenshortUtility(driver, "RedirectToLoginAfterLogout");
